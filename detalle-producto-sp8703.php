...
<head>
  <?php
    $setvar = array(
      "titulo"      => "Producto: SP8703",
      "follow"      => "",
      "description" => "Detalle producto: SP8703",
      "keywords"    => "sp8703",
      "active"      => [4, 0],
    );
  ...
  <section class="container-fluid m-0 p-0  wrap-s1 position-relative">
    ...
    <div class="position-absolute w-100 wrap-text">
      <div class="container wrap-content">
        <h1 class="text-white h1 fw-600">Detalle Producto: SP8703</h1>
      </div>
    </div>
  </section>
    ...
    <section>
      <div class="container d-inline d-md-flex my-3 my-md-5">
        ...
        <div class="f-montserrat fs-1x-25 col-12 col-md-6 col-lg-9 text-justify">
          ...
          <p class="pt-3">
            Skypatrol presenta su SP8703, el dispositivo de rastreo personal más avanzado de su cartera. Este mini dispositivo incluye conexión WIFI, botón SOS y un acelerómetro de 3 ejes.
          </p>
          <p>
            Opera de manera única en todo el mundo en redes 2G y 3G. El dispositivo incluye un GPS súper sensible con una precisión de hasta 2,5 metros. Es una solución ideal para seguridad personal, aplicaciones policiales, militares y seguimiento de activos. Manténgase conectado con una batería de larga duración y una conexión WIFI.
          </p>
          <div class="text-right fs-1x fs-md-1x-25 col-12">
            <a href="./recursos/SP8703.pdf" class="m-auto text-decoration-none bg-primary py-1 px-4 px-md-3 rounded-pill t-montserrat text-white" target="_blank"><i class='bx bxs-primary'></i>Descargar ficha técnica</a>
          </div>
        </div>
      </div>
  </section>
