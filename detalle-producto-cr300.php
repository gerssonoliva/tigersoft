...
<head>
  <?php
    $setvar = array(
      "titulo"      => "Producto: CR300",
      "follow"      => "",
      "description" => "Detalle de producto: CR300",
      "keywords"    => "cr300",
      "active"      => [4, 0],
    );
  ...
  <section class="container-fluid m-0 p-0  wrap-s1 position-relative">
    ...
    <div class="position-absolute w-100 wrap-text">
      <div class="container wrap-content">
        <h1 class="text-white h1 fw-600">Detalle Producto: CR300</h1>
      </div>
    </div>
  </section>
