...
<head>
  <?php
    $setvar = array(
      "titulo"      => "Producto: Cello IQ",
      "follow"      => "",
      "description" => "Detalle de producto: Cello IQ",
      "keywords"    => "cello iq, celloiq",
      "active"      => [4, 0],
    );
  ...
  <section class="container-fluid m-0 p-0  wrap-s1 position-relative">
    ...
    <div class="position-absolute w-100 wrap-text">
      <div class="container wrap-content">
        <h1 class="text-white h1 fw-600">Detalle producto: Cello IQ</h1>
      </div>
    </div>
  </section>
