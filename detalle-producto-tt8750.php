...
<head>
  <?php
    $setvar = array(
      "titulo"      => "Producto: TT8750+",
      "follow"      => "",
      "description" => "Detalle producto: TT8750+",
      "keywords"    => "tt8750+",
      "active"      => [4, 0],
    );
  ...
  <section class="container-fluid m-0 p-0  wrap-s1 position-relative">
    ...
    <div class="position-absolute w-100 wrap-text">
      <div class="container wrap-content">
        <h1 class="text-white h1 fw-600">Detalle Producto: TT8750+</h1>
      </div>
    </div>
  </section>
  ...
  <section>
      <div class="container d-inline d-md-flex my-3 my-md-5">
        ...
        <div class="border-bottom">
          <p class="text-primary text-uppercase fs-1x-50 fw-600">Tt8750+</p>
        </div>
          <p class="pt-3">
          ...
          <div class="text-right fs-1x fs-md-1x-25 col-12">
            <a href="./recursos/TT8750.pdf" class="m-auto text-decoration-none bg-primary py-1 px-4 px-md-3 rounded-pill t-montserrat text-white" target="_blank"><i class='bx bxs-primary'></i>Descargar ficha técnica</a>
          </div>
        </div>
      </div>
  </section>
